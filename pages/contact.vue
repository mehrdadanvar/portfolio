<template>
  <div class="flex flex-row">
    <h1>hello from contant</h1>
    <div class="carts" v-for="x in carts" :key="x">
      <cart title="something" :body="body[x]" />
    ...
    <div class="isolate bg-white py-24 px-6 sm:py-32 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        ...
        <p class="mt-2 text-lg leading-8 text-gray-600">
          I will get back to you as soon as I can. In case I dont, feel free to
