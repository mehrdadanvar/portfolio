<template>
  <div class="flex flex-col items-center py-16">
    <div class="h-32 w-32">
      <HeadlessTransitionRoot appear :show="isShowing" as="template" enter="transform transition duration-[400ms]"
        enter-from="opacity-0 rotate-[-120deg] scale-100"
    ...
    <HeadlessTransitionRoot :show="false">
      this is transition root
    </HeadlessTransitionRoot>
  </div>
</template>
